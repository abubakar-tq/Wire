          ...
          <aside className="space-y-4">
            <div className="rounded-xl border border-slate-200 bg-white p-5">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Legacy Passport</p>
                  <h2 className="mt-1 text-2xl font-bold text-slate-900">{level.name}</h2>
                  <p className="mt-1 text-sm text-slate-500">{passportStats ? `Passport #${passportStats.tokenId}` : "Join a contest to mint"}</p>
                </div>
              ...
              <div className="mt-5 grid grid-cols-2 gap-2">
                <MiniStat label="Entries" value={passportStats?.contestsEntered.toString() ?? "0"} />
                <MiniStat label="Wins" value={passportStats?.contestsWon.toString() ?? "0"} />
              </div>
            </div>
